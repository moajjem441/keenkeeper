...
const FooterPage = () => {
  ...
  <div>
    <Image src="/assets/logo-xl.png" alt="KeenKeeper Logo" width={280} height={63} />
  </div>
  <p>Your personal shelf of meaningful connections. Browse, tend, and nurture the relationships that matter most.</p>
  <div>

    <div><p className="font-bold">Socials Links</p></div>
  ...
  <aside>
    <div className="flex justify-around items-center w-full sm:gap-8 md:gap-16 lg:gap-82">
        <div>
